...
export type QuestionRoadmapTypeType =
  | 'none'
  | 'blocker'
  | 'fyi'
...
export type QuestionWhereInput = {
  ...
  readonly askedAt?: DateTimeNullableFilter | null
  readonly roadmapType?: QuestionRoadmapTypeTypeNullableFilter | null
  readonly department?: DepartmentWhereInput | null
...
export type QuestionRoadmapTypeTypeNullableFilter = {
  readonly equals?: QuestionRoadmapTypeType | null
  readonly in?: ReadonlyArray<QuestionRoadmapTypeType> | QuestionRoadmapTypeType | null
  readonly notIn?: ReadonlyArray<QuestionRoadmapTypeType> | QuestionRoadmapTypeType | null
  readonly not?: QuestionRoadmapTypeTypeNullableFilter | null
}
...
export type QuestionOrderByInput = {
  ...
  readonly status?: OrderDirection | null
  readonly askedAt?: OrderDirection | null
  readonly roadmapType?: OrderDirection | null
}
...
export type QuestionUpdateInput = {
  ...
  readonly askedAt?: any | null
  readonly roadmapType?: QuestionRoadmapTypeType | null
  readonly department?: DepartmentRelateToOneForUpdateInput | null
...
type ResolvedQuestionCreateInput = {
  ...
  askedAt?: import('@prisma/client').Prisma.QuestionCreateInput['askedAt']
  roadmapType?: import('@prisma/client').Prisma.QuestionCreateInput['roadmapType']
...
type ResolvedQuestionUpdateInput = {
  ...
  askedAt?: import('@prisma/client').Prisma.QuestionUpdateInput['askedAt']
  roadmapType?: import('@prisma/client').Prisma.QuestionUpdateInput['roadmapType']
...
export declare namespace Lists {
  export type Role<Session = any> = import('@keystone-6/core').ListConfig<Lists.Role.TypeInfo<Session>>
  namespace Role {
  ...
  export type Department<Session = any> = import('@keystone-6/core').ListConfig<Lists.Department.TypeInfo<Session>>
  ...
  export type Brand<Session = any> = import('@keystone-6/core').ListConfig<Lists.Brand.TypeInfo<Session>>
  namespace Brand {
  ...
  export type Asset<Session = any> = import('@keystone-6/core').ListConfig<Lists.Asset.TypeInfo<Session>>
  namespace Asset {
  ...
  export type Content<Session = any> = import('@keystone-6/core').ListConfig<Lists.Content.TypeInfo<Session>>
  namespace Content {
  ...
  export type AuditLog<Session = any> = import('@keystone-6/core').ListConfig<Lists.AuditLog.TypeInfo<Session>>
  namespace AuditLog {
  ...
  export type AnalyticsEvent<Session = any> = import('@keystone-6/core').ListConfig<Lists.AnalyticsEvent.TypeInfo<Session>>
  ...
  export type Question<Session = any> = import('@keystone-6/core').ListConfig<Lists.Question.TypeInfo<Session>>
  namespace Question {
    export type Item = import('@prisma/client').Question
    export type TypeInfo<Session = any> = {
      key: 'Question'
      isSingleton: false
      fields: 'id' | 'subject' | 'body' | 'status' | 'askedAt' | 'roadmapType' | 'department' | 'askedBy' | 'tags'
      item: Item
      inputs: {
